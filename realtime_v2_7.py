...
while True:
        ...
        for cnt in contours:
            ...
            for scnt in sub_contours:
                ...
                if mm_per_pixel:
                    ...
                    # ➤ Enviar por Serial solo si cambia clasificación y ha pasado el cooldown
                    ahora = time.time()
                    if clasificacion != ultima_clasificacion and (ahora - ultimo_envio_timestamp > 1.0):
    ...
    if ultimo_mensaje_enviado:
        cv2.putText(frame, ultimo_mensaje_enviado, (10, 85),
