...
# Archivo para guardar mm_per_pixel
calib_file = "calibracion.json"
mm_per_pixel = None
min_ancho_vastago = None
mensaje_calibracion = ""

# Intentar leer calibración previa
    ...
    for mask in masks:
        ...
        for cnt in contours:
            ...
            for scnt in sub_contours:
                ...
                # Calibrar con M3 si aún no calibrado
                if mm_per_pixel is None and 20 <= sw <= 80:
                    mm_per_pixel = 3.0 / sw
